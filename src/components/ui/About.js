  ...
  <header>
      <div className="header-content">
          <div className="header-content-inner">
              <div className="name-border center">
                  <h1 id="home-heading">Philip Corr</h1>
              </div>
               <a href="https://ie.linkedin.com/in/philip-corr"> 
                  <img id="headshot" src="img/phil.jpg"/>       
              </a>
              <div className="container-fluid fill light-white-font typing">
                  <div id="home" className="container-fluid fill dark-gray-background">
                       <h1 className="center text-center">
                        <p>I enjoy <span className="element"></span></p>
                      </h1>
                  </div>
              </div>
          </div>
